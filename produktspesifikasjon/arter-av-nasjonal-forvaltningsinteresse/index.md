...
Områder knyttet til sensitive artsdata, dvs. forekomster som det ikke skal være allmenn tilgang til detaljert informasjon om, er inkludert i dette datasettet under verdsatte arter - sensitive - områder.*
...
> **Romlig oppløsning:**
>
> **Ekvivalent målestokk**: 1000-50000
>
> **Begrensninger:**
>
...
| Atom Feed | [Lenke](https://pgisnedlasting.blob.core.windows.net/data/atom/datasett/art_nasjonal.xml) | W3C:AtomFeed | FILEGDB, GML | kommunevis, fylkesvis, landsfiler |
...
3. Verdsatte arter - sensitive - områder
Kartlaget viser maskeringsruter for sensitive artsdata, for arter som har en verdikategori Middels', 'Stor' eller 'Svært stor' verdi i henhold til Veileder M-1941 Konsekvensutredning av klima og miljø.

4. Prioriterte arter - punkt
Kartlaget viser punktforekomster for arter som prioritert art etter egen forskrift.

5. Prioriterte arter - områder - Naturbase
...
15. Fremmede arter - punkt
Kartlaget viser punktforekomster for fremmede arter i risikokategoriene 'Høy' og 'Svært høy' risiko.

16. Fremmede arter - områder
Kartlaget viser områdeforekomster for fremmede arter i risikokategoriene 'Høy' og 'Svært høy' risiko.

- **Produktark:** [https://register.geonorge.no/register/versjoner/produktark/miljodirektoratet/arter-av-nasjonal-forvaltningsinteresse](https://register.geonorge.no/register/versjoner/produktark/miljodirektoratet/arter-av-nasjonal-forvaltningsinteresse)
